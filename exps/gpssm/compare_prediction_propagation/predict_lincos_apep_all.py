...
def predict_using_trained_models():    
    ...
    for dyn_noise in dyn_noises:
        for emi_noise in emi_noises:
            ...
            np.savetxt('res/lincos_mm_ll_mean_%.2f_%.2f.txt'%(dyn_noise, emi_noise), mm_ll_mean, fmt='%.5f', delimiter=',')
            np.savetxt('res/lincos_mm_ll_error_%.2f_%.2f.txt'%(dyn_noise, emi_noise), mm_ll_error, fmt='%.5f', delimiter=',')
            np.savetxt('res/lincos_lin_ll_mean_%.2f_%.2f.txt'%(dyn_noise, emi_noise), lin_ll_mean, fmt='%.5f', delimiter=',')
            np.savetxt('res/lincos_lin_ll_error_%.2f_%.2f.txt'%(dyn_noise, emi_noise), lin_ll_error, fmt='%.5f', delimiter=',')
            np.savetxt('res/lincos_mc_ll_mean_%.2f_%.2f.txt'%(dyn_noise, emi_noise), mc_ll_mean, fmt='%.5f', delimiter=',')
            np.savetxt('res/lincos_mc_ll_error_%.2f_%.2f.txt'%(dyn_noise, emi_noise), mc_ll_error, fmt='%.5f', delimiter=',')           
...
def plot_res():
    ...
    for dyn_noise in dyn_noises:
        for emi_noise in emi_noises:
            ...
            mm_ll_error = np.loadtxt('res/lincos_mm_ll_error_%.2f_%.2f.txt'%(dyn_noise, emi_noise), delimiter=',')
            lin_ll_mean = np.loadtxt('res/lincos_lin_ll_mean_%.2f_%.2f.txt'%(dyn_noise, emi_noise), delimiter=',')
            lin_ll_error = np.loadtxt('res/lincos_lin_ll_error_%.2f_%.2f.txt'%(dyn_noise, emi_noise), delimiter=',')
            mc_ll_mean = np.loadtxt('res/lincos_mc_ll_mean_%.2f_%.2f.txt'%(dyn_noise, emi_noise), delimiter=',')
            ...
            plt.savefig('/tmp/lincos_pred_ll_%.2f_%.2f.pdf'%(dyn_noise, emi_noise), bbox_inches='tight')
