...
# load datasets
y_train = np.loadtxt('data/lincos_train_%d.txt'%index)
...
model_aep.save_model('trained_models/lincos_aep_model_index_%d_M_%d_alpha_%.4f_%s.pickle' % (index, M, alpha, prop_mode))
