...
for dyn_noise in dyn_noises:
    for emi_noise in emi_noises:
        ...
        plt.savefig('/tmp/kink_pred_%.2f_%.2f.pdf'%(dyn_noise, emi_noise), bbox_inches='tight')
        ...
        yplot = np.linspace(-2, 7, 300).reshape((300, ))
        ...
        plt.savefig('/tmp/kink_pred_marginals_%.2f_%.2f.pdf'%(dyn_noise, emi_noise), bbox_inches='tight')
